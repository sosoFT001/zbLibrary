...
public class AboutActivity extends BaseActivity implements OnClickListener, OnLongClickListener, OnBottomDragListener {
	...
	public void initEvent() {
		...
		findView(R.id.llmystuding_AboutActivity,this).setOnLongClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.ivAboutQRCode:
			downloadApp();
			break;
			case R.id.llmystuding_AboutActivity:
				toActivity(new Intent(getActivity(), MyStudingMainActivity.class));
				break;
		default:
			break;
		}
